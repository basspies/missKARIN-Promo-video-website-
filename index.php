  ...
  <div class="container">
    ...
    <div class="services-grid">
      ...
      <div class="service-card">
        ...
        <p>Wij bieden erkende inburgeringscursussen aan op maat. De school voldoet aan de kwaliteitseisen van de Rijksoverheid. In kleine groepen werken deelnemers doelgericht naar het gewenste taalniveau.</p>
      </div>
      <div class="service-card">
        <h3>KNM Module</h3>
      ...
      <div class="service-card">
        ...
        <p>Als u bijna klaar bent met uw inburgering bieden wij een speciaal examentrainingsprogramma. Lezen, Schrijven, Spreken en Luisteren — zodat u optimaal voorbereid bent voor het examen.</p>
      </div>
      <div class="service-card">
        <h3>Privéles</h3>
        <p>Wilt u meer individuele aandacht? Een privéles is ideaal. Spreken, lezen, schrijven — kies zelf wat u wilt verbeteren. Volledig op uw eigen tempo en niveau, met een persoonlijke trainer.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ══════════ GARANTIES ══════════ -->
<div class="teal-band"><h2>GARANTIES</h2></div>
...
<section id="integratie" style="padding:0;">
  ...
  <div class="taalles-split">
    ...
    <div class="split-text">
      ...
      <p>Wij bieden kwalitatieve taalcursussen voor niet-moedertaalsprekers op niveau A1 t/m CNaVT. Onze lessen worden gegeven door enthousiaste, erkende docenten in kleine groepen — zodat u altijd de aandacht krijgt die u nodig heeft.<br><br>
      Weet u niet welke les bij u past? We starten altijd met een gratis intakegesprek om het juiste niveau te bepalen.</p>
    </div>
  </div>
...
<div class="teal-band"><h2>BEGELEIDING NAAR WERK</h2></div>
