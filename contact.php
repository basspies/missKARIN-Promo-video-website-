  ...
  <header>
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="contact.php" style="color:var(--teal); border-bottom:2px solid var(--teal);">Contact</a>
        </li>
      </ul>
    </nav>
  </header>
  ...
  <div class="page-wrapper">
    ...
    <div class="form-bg">
      <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=900&fit=crop&auto=format"
        alt="missKARIN taalles" onerror="this.style.display='none'">
      <div class="form-bg-overlay">
        <h2>Aanmeld<br>formulier</h2>
        <p>Vul het formulier in en wij nemen zo snel mogelijk contact met u op om uw aanmelding te
          bespreken.<br><br>
      ...
      <form action="submit.php" id="aanmeld-form" novalidate method="post">
        ...
        <div class="form-group">
          ...
          <select id="cursus" name="cursus">
            ...
            <option value="dna">ONA Module</option>
            ...
            <option value="online">Online leseen</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea id="bericht" name="bericht"
            placeholder="Vertel ons meer over uw situatie of stel een vraag..."></textarea>
        </div>
